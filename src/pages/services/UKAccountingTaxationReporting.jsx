        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive accounting and tax services tailored for UK businesses.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 text-lg mb-8">
              This page is currently under development. Detailed information about our UK Accounting, Taxation & Reporting services will be available soon.
            </p>
            <div className="bg-gray-50 rounded-lg p-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Coming Soon</h2>
              <p className="text-gray-600">
                We're working on bringing you comprehensive details about our accounting, taxation, and reporting services. 
