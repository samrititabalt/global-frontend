        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4">
              <span className="text-blue-600">Recruitment</span> & Staffing
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Find the right talent for your business with our comprehensive recruitment and staffing solutions.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 text-lg mb-8">
              This page is currently under development. Detailed information about our Recruitment & Staffing services will be available soon.
            </p>
            <div className="bg-gray-50 rounded-lg p-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Coming Soon</h2>
              <p className="text-gray-600">
                We're working on bringing you comprehensive details about our recruitment and staffing services. 
