...
const MarketResearchPublicDashboard = () => {
        ...
        {!access.allowed ? (
          ...
          <>
            <section className="max-w-6xl mx-auto px-6 py-12">
              <h1 className="text-3xl font-bold text-gray-900">MR 360 Platform — {displayName}</h1>
              <p className="text-gray-600 mt-2">
                Main insights dashboard for {displayName}. Updated quarterly with dedicated researcher coverage.
              </p>
            </section>
...
export default MarketResearchPublicDashboard;
