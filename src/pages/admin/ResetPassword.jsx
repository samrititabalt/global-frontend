            ...
            <form onSubmit={handleVerifyOTP} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={6}
                  pattern="[0-9]{6}"
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 text-center text-2xl font-mono tracking-widest"
                  placeholder="000000"
                />
