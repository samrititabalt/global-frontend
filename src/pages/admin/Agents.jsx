  ...
  useEffect(() => {
    if (searchTerm) {
      ...
      const filtered = agents.filter(agent => {
        ...
        const phoneMatch = agent.phone?.toLowerCase().includes(searchLower);
        const countryMatch = agent.country?.toLowerCase().includes(searchLower);
        
        // Check single service category
        const singleCategoryMatch = agent.serviceCategory?.name?.toLowerCase().includes(searchLower);
        
        // Check multiple service categories
        const multiCategoryMatch = agent.serviceCategories?.some(cat => 
          (cat.name || cat).toLowerCase().includes(searchLower)
        );
        
        return nameMatch || emailMatch || phoneMatch || countryMatch || singleCategoryMatch || multiCategoryMatch;
      });
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 border border-gray-200">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search by name, email, phone, country, or service category..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition"
            />
            {searchTerm && (
              <button
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            ...
            <p className="text-sm text-gray-500 mt-1">Manage and monitor all your agents</p>
          </div>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-1.5">
                          <button
                            ...
                            className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-500 transition shadow-sm"
                            title="Edit Agent"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-purple-500 transition shadow-sm"
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-green-500 transition shadow-sm"
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-red-500 transition shadow-sm"
                            title="Delete Agent"
                          >
